...
st.markdown('<h1 style="color: blueviolet;">PhonePe Data Visualization And Exploration</h1>', unsafe_allow_html=True)

selected = option_menu(None,
                       options = ["About","Home","Reports","Explore",],
...
if selected == "About":
    ...
    col1.image(Image.open("PhonePe.PNG"), width=150)
    with col1:
    ...
    with col2:
        st.video("C:/Users/sumat/Downloads/New folder (3)/home-fast-secure-v3.mp4")

# HOME TAB
if selected == "Home":
    col1,col2 = st.columns(2)
    with col1:
        st.image(Image.open("phonepe2.PNG"), width=500)
    with col2:
...
if selected == "Explore":
    ...
    if select == "1.Top 10 states based on year and amount of transaction":
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("1.Top 10 states based on amount of transaction")
    ...
    #2
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("2.Least 10 states based on amount of transaction")
            st.bar_chart(data=df, x="Transaction_amount", y="States")
    ...
    #3
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("3.Top 10 States and Districts based on Registered Users")
    ...
    #4
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("4.Least 10 States and Districts based on Registered Users")
            st.bar_chart(data=df, x="RegisteredUsers", y="States")
    ...
    #5
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("5.Top 10 Districts based on Transaction Amount")
    ...
    #6
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("6.Least 10 Districts based on Transaction Amount")
            st.bar_chart(data=df, x="Districts", y="Transaction_amount")
    ...
    #7
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("7.Top 10 Districts based on Transaction Count")
    ...
    #8
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("8.Top 10 Districts based on the Transaction Count")
            st.bar_chart(data=df, x="Transaction_Count", y="Districts")
    ...
    #9
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("9.Top Transaction Types based on the Transaction Amount")
    ...
    #10
        ...
        with col1:
            st.write(df)
        with col2:
            st.title("10. Top 10 Mobile Brands based on User count of transaction")
